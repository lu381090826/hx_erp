...
<head>
    ...
    <link rel="icon" type="image/png" href="<?=$base_url?>assets/i/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="<?=$base_url?>assets/i/app-icon72x72@2x.png">
...
<script src="<?=$base_url?>assets/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->
<script src="<?=$base_url?>assets/js/amazeui.min.js"></script>
