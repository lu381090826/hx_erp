...
//{$this->CurrentUrl}={$this->TotalPages}    
    public function GetPagerContent() {    
        ...
        {    
            $str .="<a href='javascript:void(0)' class='tips' onclick='order_page(1)' title='首页'>首页</a> "."\n";    
                    $str .="<a href='javascript:void(0)' class='tips' onclick='order_page({$this->pageIndex}-1)' title='上一页'>上一页</a> "."\n"."\n";    
        }    
        ...
        */   
         ...
         {    
            ...
            {    
                       ...
                       {    $currnt="";    }    
                        $str .="<a href='javascript:void(0)' {$currnt} onclick='order_page($i)'>$i</a>"."\n" ;    
            }    
         }else                                //10页以上    
         {   if($this->pageIndex<3)  //当前页小于3    
             {    
                 ...
                 {    
                      $str .="<a href='javascript:void(0)' onclick='order_page($i)'>$i</a>"."\n" ;    
        ...
        */   
        ...
        {    
            $str .="\n"."<a href='javascript:void(0)' onclick='order_page({$this->pageIndex}+1)' class='tips' title='下一页'>下一页</a> "."\n";    
            $str .="<a href='javascript:void(0)' onclick='order_page({$this->totalPagesCount})' class='tips' title='末页'>末页</a> "."\n" ;    
        }           
